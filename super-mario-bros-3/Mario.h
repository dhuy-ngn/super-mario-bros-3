...
#define MARIO_ENTER_PIPE_INTERVAL 1000
...
public:
	...
	BOOLEAN CanFly() { return level == MARIO_LEVEL_RACCOON && this->canFly; }
	BOOLEAN CanLand() { return level == MARIO_LEVEL_RACCOON && this->canLand; }
